...
echo "--- Cypher ---"
py lexical_analyzer.py "out/cypher/match_queries.cypher" "out/output-cypher-lexical.json"
py complexity_analyzer.py "cypher" "complexity.json" "out/output-cypher-lexical.json" "out/output-cypher-complexity.json"

echo "--- SQL ---"
py lexical_analyzer.py "out/sql/select_queries.sql" "out/output-sql-lexical.json"
